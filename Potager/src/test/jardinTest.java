...
public class jardinTest {
	...
	public void testVoisinsCasesCoin() {
		...
		if(!voisins.containsAll(resultatAttendu)){
			fail("La méthode ne retrouve pas tous les voisins dans le coin");
		}
		if(voisins.size()!=resultatAttendu.size()){
			fail("La méthode trouve trop de voisins dans le coin");
		}
	}
	...
	public void testVoisinsCasesCentre(){
		...
		if(!voisins.containsAll(resultatAttendu)){
			fail("La méthode ne retrouve pas tous les voisins au centre");

		}
		if(voisins.size()!=resultatAttendu.size()){
			fail("La méthode trouve trop de voisins au centre");
		}
	}
